...
class validateargs:
    ...
    def FormattingMethod():
        ...
        # exportados
        # [>] Por enquanto o cálculo está fixo com a quantidade de  mé-
        # todos de formatações escolhidos, adicionado 1 que seria o ar-
        # quivo sem formatação, e mutiplicado por 2, pois são dois  mé-
        # todos de leitura nos quais as formatações se baseiam (lattice
        # e stream)
        fvar.quantity_ExportedFiles = (len(FormattingMethod) + 1) * 2

...
#region BACKUP DOCSTRING

# # [C] REGEX
# # -------------------------------------------------------------
# # Descrição:
# # Variáveis que possuem relações com Regex, principalmente,  no
# # que diz respeito aos métodos utilizados nesse módulo.
# # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
# # [i] Variável que vai segurar o item que vai ser  trazido  por
# # um método público, e ter o seu valor validado  dentro  de  um
# # método privado
# ContentValue = ""
# # [i] Variável que vai armazenar a regra do Regex passado pelos
# # métodos públicos que vai ser utilizada dentro  de  um  método
# # privado
# Regex = ""
# # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
# # -------------------------------------------------------------

...
def SetFolderStructure():
    ...
    FolderSufix = ""
    foldername_OldResult = fvar.foldername_Result
    # [>] Caminho da pasta de resultados sem o sufixo
    fvar.folderpath_Result = fvar.folderpath_Export + "\\" + fvar.foldername_Result
    ...
    while (os.path.isdir(fvar.folderpath_Result)):
        ...
        fvar.foldername_Result = foldername_OldResult + FolderSufix
